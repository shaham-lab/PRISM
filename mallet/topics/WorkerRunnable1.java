...
// 	protected int doc; // Current document being processed
...
// 	double checkSmoothingOnlyMass = 0;
...
//             int[] topics = topicSequence.getFeatures(); // topics has same value as in origin mallet
...
// 		try (FileWriter fileWriter = new FileWriter("tokens_per_topic_debug.txt", true);
// 			 PrintWriter printWriter = new PrintWriter(fileWriter)) {
...
// 			smoothingOnlyMass = new double[numTypes];
// 			// Arrays.fill(smoothingOnlyMass, 0.0);
// 			// double[][] typeTopicSmoothingMass = new double[numTypes][numTopics];
...
// 					smoothingOnlyMass[type] += alpha[topic] * beta[type] / (tokensPerTopic[topic] + betaSum);
// 				}
// 				// System.out.println("smoothingOnlyMass[type]: " + smoothingOnlyMass[type]);
// 			}

// 			for (int topic=0; topic < numTopics; topic++) {
// 				checkSmoothingOnlyMass += alpha[topic] * 0.01 / (tokensPerTopic[topic] + betaSum);
// 			}

// 			// for (int type = 0; type < numTypes; type++) {
// 			// 	for (int topic = 0; topic < numTopics; topic++) {
// 			// 		typeTopicSmoothingMass[type][topic] =
// 			// 			alpha[topic] * beta[type] / (tokensPerTopic[topic] + betaSum);
// 			// 	}
// 			// 	// maybe put smoothingOnlyMass here as a sum over typeTopicSmoothingMass.
// 			// }
...
// 				// System.err.println("Processing doc " + doc + " of " + data.size() + " tokens: " + tokenSequence.size());
// 				// if (doc == 18) {
// 				// 	System.out.println("doc 18");
// 				// }
...
// 	 * 
// 	 * 		P( z_i=k | w_i=v,d ) ∝ (n_d,k + alpha) / (n_d + alphaSum) * (n_k,v + beta) / (n_k + betaSum)
// 	 * 
...
// 		double[] topicBetaMass = new double[numTypes];	
// 		Arrays.fill(topicBetaMass, 0.0);
// 		double checkTypeTopicBetaMass = 0.0;
...
// 				topicBetaMass[type] += beta[type] * n /	(tokensPerTopic[topic] + betaSum);	
				
// 			}
// 			checkTypeTopicBetaMass += 0.01 * localTopicCounts[topic] / (tokensPerTopic[topic] + betaSum);
...
// 			// double checkTypeTopicBetaMass = 0.0;
// 			// for (int j=0; j < nonZeroTopics; j++) {
// 			// 	int topic = localTopicIndex[j];
// 			// 	checkTypeTopicBetaMass += beta[type] * localTopicCounts[topic] / (tokensPerTopic[topic] + betaSum);
// 			// }

// 			// if (doc == 18) {
// 			// 	System.out.println("Before - topicBetaMass: " + topicBetaMass[type]);
// 			// 	System.out.println("Before - checkTypeTopicBetaMass: " + checkTypeTopicBetaMass);
// 			// 	System.out.println("Before - smoothingOnlyMass: " + smoothingOnlyMass[type] + "\n");
// 			// }

// 			// System.out.println("Before - smoothingOnlyMass[type]: " + smoothingOnlyMass[type] + "\n");
// 			// System.out.println("Before - smoothingOnlyMass: " + checkSmoothingOnlyMass + "\n");
...
// 				smoothingOnlyMass[type] -= alpha[oldTopic] * beta[type] / 
// 					(tokensPerTopic[oldTopic] + betaSum);

// 				topicBetaMass[type] -= beta[type] * localTopicCounts[oldTopic] /
// 					(tokensPerTopic[oldTopic] + betaSum);

// 				checkSmoothingOnlyMass -= alpha[oldTopic] * 0.01 / 
// 					(tokensPerTopic[oldTopic] + betaSum);
// 				checkTypeTopicBetaMass -= 0.01 * localTopicCounts[oldTopic] /
// 					(tokensPerTopic[oldTopic] + betaSum);
				
// 				// if (doc == 18) { 
// 				// 	// System.out.println("value to subtrut: " + (beta[type] * localTopicCounts[oldTopic] / (tokensPerTopic[oldTopic] + betaSum)));
// 				// 	System.out.println("After - topicBetaMass: " + topicBetaMass[type]);
// 				// 	checkTypeTopicBetaMass -= beta[type] * localTopicCounts[oldTopic] / (tokensPerTopic[oldTopic] + betaSum);
// 				// 	System.out.println("After - checkTypeTopicBetaMass: " + checkTypeTopicBetaMass);
// 				// 	System.out.println("After - smoothingOnlyMass: " + smoothingOnlyMass[type] + "\n");
// 				// }
...
// 			// Sample a New Topic
// 			double typeSmoothingMass = smoothingOnlyMass[type];
// 			double typeTopicBetaMass = topicBetaMass[type];

// 			// checkTypeTopicBetaMass = 0.0;
// 			// // double checkTypeSmoothingMass = 0.0;
// 			// for (int j=0; j < nonZeroTopics; j++) {
// 			// 	int topic = localTopicIndex[j];
// 			// 	checkTypeTopicBetaMass += beta[type] * localTopicCounts[topic] / (tokensPerTopic[topic] + betaSum);
// 			// }
...
// 			// if (doc == 18) {
// 			// 	System.out.println("checkTypeTopicBetaMass: " + checkTypeTopicBetaMass);
// 			// 	System.out.println("typeTopicBetaMass: " + topicBetaMass[type]);
// 			// }

// 			double sample = random.nextUniform() * (checkSmoothingOnlyMass + checkTypeTopicBetaMass + topicTermMass);
...
// 				// System.err.println("In TopicTermMass");
// 				//topicTermCount++;
...
// 				if (sample < typeTopicBetaMass) {
// 					// System.err.println("In TypeTopicBetaMass");
// 					//betaTopicCount++;
...
// 				}
// 				else {
// 					// System.err.println("In SmoothingOnlyMass");
// 					//smoothingOnlyCount++;

// 					sample -= typeTopicBetaMass;
...
// 			if (newTopic == -1) {
// 				System.err.println("WorkerRunnable sampling error: "+ origSample + " " + sample + " " + typeSmoothingMass + " " + 
// 						typeTopicBetaMass + " " + topicTermMass + " POSITION: " + position);
// 				newTopic = random.nextInt(numTopics); // TODO is this appropriate
...
// 			smoothingOnlyMass[type] -= alpha[newTopic] * beta[type] / 
// 				(tokensPerTopic[newTopic] + betaSum);
// 			topicBetaMass[type] -= beta[type] * localTopicCounts[newTopic] /
// 				(tokensPerTopic[newTopic] + betaSum);

// 			checkSmoothingOnlyMass -= alpha[newTopic] * 0.01 /
// 				(tokensPerTopic[newTopic] + betaSum);
// 			checkTypeTopicBetaMass -= 0.01 * localTopicCounts[newTopic] /
// 				(tokensPerTopic[newTopic] + betaSum);
